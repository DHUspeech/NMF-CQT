function [y4,y5,y6]=Denoising_fft_gft(y,Wg1,Wg2,Wg3,W1,W2,W3,H1,H2,H3,all_r,fs,B,qz,alg,iter_num2,number_bases)
...
%      absMix3=multiframes2(absMix3);
     ...
     absMix3=absSp3(1:all_r,:);
     absMix3=multiframes2(absMix3);%重复帧
     H2=H2(:,1:Mixframes);
     Mix3=size(absSp3,2);
     H3=H3(:,1:Mix3);
...
%     V3=[V3(1:all_r,:);V3(end-1:-1:2,:)];
    y6=Ifft_gft(U,angle_gft,V3,phse_spectrum,fs,Nframes,resdiuePoint);