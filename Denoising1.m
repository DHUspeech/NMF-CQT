function [y4,y5,y6]=Denoising1(y,Wg1,Wg2,Wg3,W1,W2,W3,H1,H2,H3,all_r,fs,B,qz,alg,iter_num2,number_bases,X_CQT,X_FFT)
...
%      absMix3=multiframes2(absMix3);
     sp1=Xcq.c;
     [Mix_1,absMix1]=gft1(sp1,X_CQT);
     absMix1=multiframes2(absMix1);%重复帧
     Mix1=size(absMix1,2);
     H1=H1(:,1:Mix1);
     absMix2=absMix2(1:all_r,:);
     phaseMix2=phaseMix(1:all_r,:);
     sp2=absMix2.*phaseMix2;
     [Mix_3,absMix3]=gft1(sp2,X_FFT);
     Mix3=size(absMix3,2);
...
%     Xcq.c=V1.*exp(1j*Xcq.theta);
    ...
    V3=singleframe2(V3);
    V3=V3.*exp(1j*angle(Mix_3));
%     f=V3.*exp(1j*angle(x));
    V3=igft1(X_FFT,V3);
%     V3=real(V3);
    V3=[V3(1:all_r,:);V3(end-1:-1:2,:)];
    abs_v3=abs(V3);
    angle_v3=angle(V3);
    y6=Convert2Speech(abs_v3,angle_v3,fs,Mixframes,resdue); % 频域转换到时域
