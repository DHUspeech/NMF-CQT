...
%      gft_name=strcat('gft_',str_ss,noise_hz,'_',GTspeakerData(tt,1).name);
     path=strcat('Denoised_female_speech/','noisy_female/');
     name=strcat(noise_hz,str_ss,GTspeakerData(tt,1).name);
     audiowrite([path name],y,16000);
...
% save('mosM.mat','MOSs');
% save('stoM.mat','stoiS');
% save('mosF_maleS_m2L.mat','MOSf');
% save('stoF_maleS_m2L.mat','stoiF');
