...
disp('denoising Female...')
    ...
    y0=y0(:,1);
     ...
     path=strcat('Denoised_male_speech/','m1/');
     name=strcat(GTspeakerData(tt,1).name,'_',str_ss,'_',NoiseData(i,1).name);
...
% save('mosM.mat','MOSs');
% save('stoM.mat','stoiS');
% save('stoF_maS_m1.mat','stoiF');
% save('mosF_maS_m1.mat','MOSf');
end
